...
public class SeasonAdapter extends RecyclerView.Adapter<SeasonAdapter.MyViewHolder> {
   ...
   String userid;
    ...
    public SeasonAdapter(Context profile, ArrayList<MedicineModel> arrayList, String userid) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view=layoutInflater.inflate(R.layout.seasonal_item,null);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            ...
            imageView=(ImageView)itemView.findViewById(R.id.seasonal_image);
            textView=(TextView)itemView.findViewById(R.id.seasonal_text);
