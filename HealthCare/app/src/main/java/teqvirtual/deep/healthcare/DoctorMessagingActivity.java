...
public class DoctorMessagingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doctor_messaging);
        ...
        send_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (msg.isEmpty())
                {
                    Toast.makeText(DoctorMessagingActivity.this, "You Can Not Send Empty Message", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    String time = new SimpleDateFormat("hh : mm a", Locale.getDefault()).format(Calendar.getInstance().getTime());

                    SendMessage(FirebaseAuth.getInstance().getCurrentUser().getUid(),userId,msg,time,"text");
                }
    ...
    public void SendMessage(String sender, String receiver, String message, String time,String type)
    {
        DatabaseReference reference= FirebaseDatabase.getInstance().getReference();
        ...
        reference.child("Doctors").child(userId).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                String token = dataSnapshot.child("token").getValue().toString();

                reference.child("Subscribers").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot:dataSnapshot.getChildren())
                {
                    ...
                    messageAdapter=new MessageAdapter(DoctorMessagingActivity.this,chatList);
