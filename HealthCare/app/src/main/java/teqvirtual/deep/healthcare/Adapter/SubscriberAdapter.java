...
public class SubscriberAdapter extends RecyclerView.Adapter<SubscriberAdapter.MyClassViewHolder> {

    Context context;
    LayoutInflater layoutInflater;
    ArrayList<SubscriberModel> arrayList;

    public SubscriberAdapter(Context context, ArrayList<SubscriberModel> arrayList)
    {
    ...
    public MyClassViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=layoutInflater.inflate(R.layout.subscriber_list_item,null);
    ...
    public class MyClassViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyClassViewHolder(@NonNull View itemView) {
            ...
            imageView=(ImageView)itemView.findViewById(R.id.subscriber_img);
            textView=(TextView)itemView.findViewById(R.id.subscriber_name);
