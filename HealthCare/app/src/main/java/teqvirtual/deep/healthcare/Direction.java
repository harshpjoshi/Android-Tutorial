...
import MapHelper.DirectionFinder;
import MapHelper.DirectionFinderListener;
import MapHelper.Route;

public class Direction extends AppCompatActivity implements OnMapReadyCallback, LocationListener, DirectionFinderListener {

    private GoogleMap mMap;
    LocationManager locationManager;
    double start_lat, start_longi;
    double dest_lat, dest_longi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_map_hos);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        Intent intent = getIntent();
        dest_lat = Double.parseDouble(intent.getStringExtra("lat"));
        dest_longi = Double.parseDouble(intent.getStringExtra("longi"));
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        String origin=start_lat+","+start_longi;
        String destination=dest_lat+","+dest_longi;
        try {
