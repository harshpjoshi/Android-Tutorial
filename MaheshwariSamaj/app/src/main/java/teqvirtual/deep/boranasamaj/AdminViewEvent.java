...
import Adapter.AdminEventListAdapter;
...
public class AdminViewEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_event_admin);
        toolbar.setTitleTextColor(getResources().getColor(R.color.font));
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final RecyclerView recyclerView=(RecyclerView)findViewById(R.id.event_list_admin);
        ...
        new WebserviceCall(AdminViewEvent.this, url, jsonRequest, "Loading...", true, new AsyncResponse() {
            @Override
            public void onCallback(String response) {
                ...
                try {
                    ...
                    adapter=new AdminEventListAdapter(AdminViewEvent.this,eventModels);
