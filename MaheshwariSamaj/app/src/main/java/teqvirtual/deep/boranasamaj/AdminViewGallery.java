...
import Adapter.AdminGalleryListAdapter;
import Helper.AsyncResponse;
import Helper.Utils;
import Helper.WebserviceCall;
import Model.GalleryModel;

public class AdminViewGallery extends AppCompatActivity {

    AdminGalleryListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_gallery);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_gallery_admin);
        toolbar.setTitleTextColor(getResources().getColor(R.color.font));
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final RecyclerView recyclerView=(RecyclerView)findViewById(R.id.gallery_list_admin);
        ...
        new WebserviceCall(AdminViewGallery.this, url, jsonRequest, "Loading...", true, new AsyncResponse() {
            @Override
            public void onCallback(String response) {
                ...
                try {
                    ...
                    adapter=new AdminGalleryListAdapter(AdminViewGallery.this,arrayList);
