...
import Adapter.AdvertiseListAdapter;
...
public class Advertise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final RecyclerView recyclerView=(RecyclerView)findViewById(R.id.advertise_list);
        ...
        new WebserviceCall(Advertise.this, url, jsonRequest, "Loading...", true, new AsyncResponse() {
            @Override
            public void onCallback(String response) {
                ...
                try {
                    ...
                    adapter=new AdvertiseListAdapter(Advertise.this,advertiseModels);
