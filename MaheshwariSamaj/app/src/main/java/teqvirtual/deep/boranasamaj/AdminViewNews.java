...
import Adapter.AdminNewsListAdapter;
import Helper.AsyncResponse;
import Helper.Utils;
import Helper.WebserviceCall;
import Model.NewsModel;

public class AdminViewNews extends AppCompatActivity {

    AdminNewsListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_news);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_news_admin);
        toolbar.setTitleTextColor(getResources().getColor(R.color.font));
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        final RecyclerView recyclerView=(RecyclerView)findViewById(R.id.news_list_admin);
        ...
        new WebserviceCall(AdminViewNews.this, url, jsonRequest, "Loading...", true, new AsyncResponse() {
            @Override
            public void onCallback(String response) {
                ...
                try {
                    ...
                    adapter=new AdminNewsListAdapter(AdminViewNews.this,newsModels);
