    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "http://teqvirtual.com/Boranasamaj/fetchadvertise.php", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ArrayList<com.example.developer.bhuttasamaj.AdvertiseData> advertiseData=new ArrayList<>();
                    ...
                    for (int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        com.example.developer.bhuttasamaj.AdvertiseData advertiseData1=new com.example.developer.bhuttasamaj.AdvertiseData();
